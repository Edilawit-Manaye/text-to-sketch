...
def parse_args():
    ...
    parser.add_argument("--source-dir", required=True, default="data/processed/stroke5",
                        help="Source directory containing data/processed/stroke5/*.npz")
    parser.add_argument("--target-dir", required=True, default="data/sketchformer-ready-data/stroke3",

...
simplification:
    ...
    .venv/bin/python scripts/data_prep/filter_sketches_by_points.py
...
DEFAULT_INPUT_DIR = PROJECT_ROOT / "data" / "processed" / "sketches"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data" / "processed" / "sketches_max_10000"
DEFAULT_REJECTED_DIR = PROJECT_ROOT / "data" / "processed" / "sketches_over_10000"
DEFAULT_REPORT_PATH = PROJECT_ROOT / "data" / "processed" / "sketch_point_filter_report.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=10000,
        help="Reject sketches with point count above this value (default: 10000).",
    )
    parser.add_argument(
        "--epsilon",
        type=float,
...
def point_count_for(
    ...
    from pipeline.steps.vectorizer import vectorize_image_with_stats

...
from pipeline.steps.vectorizer import (
    DEFAULT_RDP_EPSILON,
    VectorizationStats,
    vectorize_image_with_stats,
)
from pipeline.utils.io import save_stroke5
from pipeline.visualization.sketch_comparison import save_original_vs_simplified
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--sketches-dir",
        type=Path,
        default=PROJECT_ROOT / "data" / "processed" / "sketches_max_10000",
...
def default_output_dir(epsilon: float) -> Path:
    ...
    return PROJECT_ROOT / "data" / "processed" / f"rdp_epsilon_{epsilon_slug}"
